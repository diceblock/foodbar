...
pipes.validateJson = function(){
	return gulp.src(paths.json)
	     .pipe(plugins.jsonlint())
         .pipe(plugins.jsonlint.reporter());
}
pipes.builtJsonDev = function(){
	return pipes.validateJson()
		   .pipe(gulp.dest(paths.distDev +'/json'))
};
...
pipes.builtPartialsDev = function() {
    return pipes.validatedPartials()
        .pipe(gulp.dest(paths.distDev+'/partials'));
};
...
pipes.builtAppDev = function() {
    return es.merge(pipes.builtIndexDev(), pipes.builtPartialsDev(), pipes.processedImagesDev(), pipes.builtJsonDev());
};
